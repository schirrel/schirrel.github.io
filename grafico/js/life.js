...
//    vis.append("svg:line").attr("x1", x(startYear)).attr("y1", y(MIN)).attr("x2", x(endYear)).attr("y2", y(MIN)).attr("class", "axis").style("stroke", function(d) { return "#000"; });
        
    vis.append("svg:line").attr("x1", x(startYear)).attr("y1", y(MIN)).attr("x2", x(startYear)).attr("y2", y(MAX)).attr("class", "axis").style("stroke", function(d) { return "#000"; });
